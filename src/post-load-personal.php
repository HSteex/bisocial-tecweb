...
<div class="text-center profile-card" style="max-width:1024px;margin: 15px;background: rgb(39, 38, 46);max-width: 1024px;margin:auto;">
    ...
    <div><img class="rounded-circle" style="margin-top:-70px;" src="/opt/lampp/htdocs/bisocial-tecweb/assets/img/propic/ogrinzosi.jpeg" height="150px">
        <h3 class="form-label"><?php echo $userInfo['nome'] . ' ' . $userInfo['cognome'];?></h3>
