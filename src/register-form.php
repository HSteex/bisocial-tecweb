 <div class="padding">
     <form action="process-register.php" method="post" class="login" name="login_form">
         <p>Ciao, registrati.</p>
         <input class="form-control login" type="text" placeholder="Username" name="username" required/>
         <input class="form-control login" type="email" placeholder="E-mail" name="email" required/>
