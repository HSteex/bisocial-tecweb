<div class="col mb-5" style="max-width:1024px;border-radius: 15px;margin-top: 10px;margin-right: 10px;margin-bottom: 10px !important;margin-left: 10px;border: 4px solid #662c94;max-width: 1024px;margin:auto;">
    <div class="card shadow-sm" style="background: rgb(45,44,56);">
        <div class="card-body px-4 py-5 px-md-5" style="border-radius: 4px;background: rgb(45,44,56);">
            ...
            </div><img class="rounded img-fluid shadow w-100 fit-cover" src="../assets/img/products/3.jpg" style="width: 150px;max-height: 250px;">
            <p class="text-muted card-text mb-4" style="font-family: 'Roboto Flex', sans-serif;">Erat netus est hendrerit, nullam et quis ad cras porttitor iaculis. Bibendum vulputate cras aenean.</p><button class="btn btn-primary shadow" type="button" style="width: 42px;height: 42px;padding: 0px;background: #662c94;margin-left: 5px;border-color: #662c94;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-hand-thumbs-up-fill" style="width: 18px;height: 18px;">
