        ...
        <div class="card shadow-sm" style="background: rgb(45,44,56);">
            <div class="card-body px-4 py-5 px-md-5" style="border-radius: 4px;background: rgb(45,44,56);">
                ...
                <div class="center">
                    ...
                    <button class="btn btn-primary shadow" type="button" onclick="toggleLike('.$post['post_id'].')"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-hand-thumbs-up-fill" style="width: 18px;height: 18px;">
                    ...
                    </svg></button><button type="submit" onclick="loadComments('.$post["post_id"].')" class="btn btn-primary shadow bi bi-hand-thumbs-up" type="button" ><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-dots-fill" style="width: 18px;height: 18px;">
...
echo '<div class="floating-div" id="floating-comments">
        <div class="floating-div-content" id="follower-content" style="padding-top: 12px;">
            ...
            <form method="post">
                ...
                <span style="width:30%">
                    <button type="submit" class="fas fa-arrow-alt-circle-up" name="btn-comment" id="comment-btn" onclick="addComment(' . $post["post_id"] . ',' . $_SESSION["user_id"] . ', document.getElementById(`comment-content`).value,notify('.$_SESSION["user_id"].','.$post["post_id"].')"></button>
                    </span>
            </form>
            </div>
        </div>
