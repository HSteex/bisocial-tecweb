        ...
        <div class="card shadow-sm" style="background: rgb(45,44,56);">
            <div class="card-body px-4 py-5 px-md-5" style="border-radius: 4px;background: rgb(45,44,56);">
                ...
                <li style="list-style-type: none;"><p class="text-muted card-text mb-4" style="font-family: "Roboto Flex", sans-serif;">' . $post['description'] . '</p></li>
                    ...
                    <button class="btn btn-primary shadow" type="button" onclick="toggleLike('.$post['post_id'].')" style="width: 42px;height: 42px;padding: 0px;background: #662c94;margin-left: 5px;border-color: #662c94;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-hand-thumbs-up-fill" style="width: 18px;height: 18px;">
                    ...
                    </svg></button><button onclick="loadComments('.$post["post_id"].')" class="btn btn-primary shadow" type="button" style="width: 42px;height: 42px;padding: 0px;background: #662c94;margin-left: 5px;border-color: #662c94;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-dots-fill" style="width: 18px;height: 18px;">
