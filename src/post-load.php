        ...
        <div class="card shadow-sm" style="background: rgb(45,44,56);">
            <div class="card-body px-4 py-5 px-md-5" style="border-radius: 4px;background: rgb(45,44,56);">
                ...
                <div class="center">
                    ...
                    <button class="btn btn-primary shadow '.$isLiked.'" id="like-button-'.$post["post_id"].'" type="button" onclick="toggleLike('.$post['post_id'].')"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-hand-thumbs-up-fill" style="width: 18px;height: 18px;">
